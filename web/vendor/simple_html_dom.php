...
class simple_html_dom_node
{
	...
	// find elements by style selector
...
//		$pattern = "/([\w-:\*]*)(?:\#([\w-]+)|\.([\w-]+))?(?:\[@?(!?[\w-]+)(?:([!*^$]?=)[\"']?(.*?)[\"']?)?\])?([\/, ]+)/is";
	...
	*/
	...
	function get_display_size()
	{
		...
		// If the class or id is specified in a SEPARATE style file thats not on the page, go get it and do what we were just doing for the ones on the page.
...
class simple_html_dom
{
	...
	// find dom node by style selector
